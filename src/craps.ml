...
let rec craps_start bet =
  ...
  if command = "Pass" then craps_come_out bet true
    ...
    print_string
      "Craps is a game of wagers between you (the shooter) and the \
       bank involving just a pair dice! When you start, you will be \
       asked to place bets on either the Pass line (the bet for the \
       shooter to win) or Don't Pass (the bet for the shooter to \
       lose). \n\
      \ \n\
      \ Then, there are two phrases to Craps: come-out and point. The \
       first roll is known as come-out. A come-out roll of 2, 3, or 12 \
       is called 'craps', 7 or 11 is a 'natural', and any other number \
       (4, 5, 6, 8, 9, 10) establishes the point for the point phase. \
       In order for the shooter (you) to pass, you must roll this \
       point number again before rolling a seven. \n\
      \ \n\
      ...
      \ Come-out roll of 7 or 11 means the bet wins. \n\
       ...
       Come-out roll of any other number n establishes a point: if n \
       is rolled again before a 7, the bet wins; if a 7 rolled is \
       rolled before n is rolled again ('seven out'), the bet loses. \n\
      \ \n\
      ...
      \ Come-out roll of 12 means the bet is a push (neither a win or \
       a loss). \n\
       Come-out roll of any other number n establishes a point: if n \
       is rolled again before a 7, the bet loses; if a 7 rolled is \
       rolled before n is rolled again ('seven out'), the bet wins. \n\
      \ \n\
       A Pass line bet, once made, cannot be taken down or reduced \
       until the round is over. However, it can be increased after a \
       point is established. \n\
       A Don't Pass bet, once made, cannot be increased after a point \
       is established, but it can be taken down or reduced. \n\
      \ \n\
       Both the Pass and Don't Pass bets pay even money (e.g. you bet \
       100, you win 100).";
    craps_start bet
  end
  else
